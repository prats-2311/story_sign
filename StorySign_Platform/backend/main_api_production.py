#!/usr/bin/env python3
"""
StorySign ASL Platform Backend - Production API
...
# Import core API modules that are working
from api import asl_world, system, harmony, reconnect, websocket
...
try:
    ...
    logger.info("Using database-backed authentication")
except ImportError:
    try:
...
app.include_router(asl_world.router)  # This has your real Groq + Ollama integration
